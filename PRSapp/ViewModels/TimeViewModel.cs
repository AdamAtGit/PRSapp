using PRSapp.CustomHelperClasses;
using PRSapp.Models;
using System;
...
namespace PRSapp.ViewModels
{
    public class TimeViewModel : INotifyPropertyChanged
    {
        ...
        public static string GetFileType(string _fileName)
        {
           ...
           string fileType = string.Empty;
            if (sfileName != null)
            {
                ...
                string fileExtension = sfileName.Substring(len - 3);
                switch (fileExtension)
                {
                    ...
                    case "wmv":
                        fileType = "video";  break;
                    case "xml":
                        fileType = "speech-xml"; break;
                    case "txt":
                        fileType = "speech-txt"; break;
                    default:
                        fileType = "unknown file type"; break;               
                }             
            }
            return fileType;
        }
        ...
        M_Speech speechModel = new M_Speech();
        #endregion
